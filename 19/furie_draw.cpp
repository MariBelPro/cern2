...
TH3D *Lambda= (TH3D*)profile1->Get("lambdy_dist");
...
TLatex latex2(-2,1160200,"#font[12]{Lambda   Au+Au #sqrt{s_{NN}}=19.6 GeV}");
latex2.SetTextSize(0.04);
latex2.DrawClone("Same");

TLatex latex(-2,1160200,"#font[12]{30-40% centrality}");
