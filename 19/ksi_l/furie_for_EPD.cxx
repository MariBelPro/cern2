...
//TH3D *Anty_Lambda= (TH3D*)profile1->Get("Antylambdy_tot");
 TProfile *acceptL  =(TProfile*)profile1->Get("acceptKsi_l");
TProfile *Anty_accept_L  =(TProfile*)profile1->Get("accept_barKsi_l");
...
for(int c=0;c<9;c++)
{
 ...
 Pol[8-c]=-345*fit_f->GetParameter(1)/(1.273*Anty_accept_L->GetBinContent(c+1)*sqrt(2*res->GetBinContent(c+1)));
 ePol[8-c]=345*fit_f->GetParError(1)/(1.273*Anty_accept_L->GetBinContent(c+1)*sqrt(2*res->GetBinContent(c+1)));
