...
fit_f->Draw();
furie[4]->SetTitle(";#Delta#phi*=#psi-#phi*_{#bar{p}} (rad);dN/d#Delta#phi*");
sin_f->Draw("same");
 cos_f->Draw("same");
 sin2_f->Draw("same");
 cos2_f->Draw("same");
...
TLatex latex2(-2,50600,"#font[12]{#bar{#Lambda} (#bar{#Xi}^{+})  Au+Au #sqrt{s_{NN}}=19.6 GeV}");
latex2.SetTextSize(0.04);
latex2.DrawClone("Same");

TLatex latex(-2,50600,"#font[12]{30-40% centrality}");
