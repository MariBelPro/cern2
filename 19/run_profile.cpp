...
void run_profile()
{
   ...
   Double_t mean_Y=110.198;
Double_t st_Y=0.215362;
Double_t mean_error=0.176017 ;
Double_t st_error=0.0426399;
    TFile *file=TFile::Open("run.root", "READ");
    TProfile *ref=(TProfile*)file->Get("hEventProfile_0;1");
...
up->Draw("same");
badrun->Draw("P");
TFile *fil=new TFile("run_profile.root","RECREATE");
ref->Write();
badrun->Write();
badrun2->Write();
