...
TFile *profile1 =TFile::Open("StEpdEpFinderCorrectionHistograms_INPUTpt.root", "READ");
...
//gStyle->SetOptStat(kFALSE);
 ...
 Double_t Pol[5]; 
     Double_t ePol[5]; 
 Double_t cent[5]= {0.33,0.705,1.075,1.445,1.815};
...
for(int c=0;c<5;c++)
{
 ...
 Pol[c]=345*fit_f->GetParameter(1)/sqrt(2*res->GetBinContent(5));
 ePol[c]=345*fit_f->GetParError(1)/sqrt(2*res->GetBinContent(5));
