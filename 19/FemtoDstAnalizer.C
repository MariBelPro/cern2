...
//_________________
void FemtoDstAnalizer(const Char_t *inFile = "st_physics_12150008_raw_4030001.femtoDst.root",
                      const Char_t *oFileName = "oTest.root") {

  std::cout << "Hi! Lets do some physics, Master!" << std::endl;

  Int_t runIdBins = 200000;
  Int_t runIdRange[2] = { 20050000, 20070000 };
...
int main(int argc, char* argv[]) {
  ...
  FemtoDstAnalizer(fileName, oFileName);
  return 1;
}
