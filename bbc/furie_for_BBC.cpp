...
TFile *profile1 =TFile::Open("bbc_out.root", "READ");
...
TF1 *fit_f=new TF1 ("par[0]*(1+2*par[1]*sin(x[0])+2*par[2]*cos(x[0])+2*par[3]*sin(2*x[0])+2*par[4]*cos(2*x[0]))",furie_fit,-2.7,2.7,5);
