...
std::cout <<"Number of events to read: " << events2read << std::endl;
 ...
 Double_t lin[9] ={-0.128683, -0.192433, -0.312888, -0.392916, -0.436082, -0.417215, -0.31517, -0.155706, -0.0400981};
  Double_t cub[9]={ 0.00824625, 0.016336, 0.0280935, 0.0390956, 0.0461735, 0.0473166, 0.0370554, 0.0195254, 0.00586234};
       ...
       TVector3 b;
        ...
        if (kfp->pdg()==3122)
        {
          ...
          if(doter_p->pdgId()==2212)
          {
            ...
            proton.Boost(-b);
           Totol_of_lambda->Fill(kfp->fourMomentum().M(), information.FullPhiWeightedAndShiftedPsi(1)-proton.Phi(),Event->cent9());
        ...
        if (kfp->pdg()== -3122)
        {
          ...
          if(doter_p->pdgId()==-2212)
          {
            ...
            anty_proton.Boost(-b);
            Totol_of_Antylambda->Fill(kfp->fourMomentum().M(),information.FullPhiWeightedAndShiftedPsi(1)-anty_proton.Phi(),Event->cent9());
          }
