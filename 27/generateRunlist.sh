...
export DATA_DIR=/mnt/pool/nica/7/nigmatkulov/star/femtoDst/auau27_2018/part2
#export DATASET=$1
...
if [ ! -f ${MAIN_DIR}/split/runlist_${DATASET}.list ] ; then
  find ${DATA_DIR}/subdata0/ -type f -name "*.femtoDst.root" > ${MAIN_DIR}/split/runlist_${DATASET}.list
  find ${DATA_DIR}/subdata1/ -type f -name "*.femtoDst.root" >> ${MAIN_DIR}/split/runlist_${DATASET}.list
  find ${DATA_DIR}/subdata2/ -type f -name "*.femtoDst.root" >> ${MAIN_DIR}/split/runlist_${DATASET}.list
  find ${DATA_DIR}/subdata4/ -type f -name "*.femtoDst.root" >> ${MAIN_DIR}/split/runlist_${DATASET}.list
  find ${DATA_DIR}/subdata5/ -type f -name "*.femtoDst.root" >> ${MAIN_DIR}/split/runlist_${DATASET}.list
  find ${DATA_DIR}/subdata6/ -type f -name "*.femtoDst.root" >> ${MAIN_DIR}/split/runlist_${DATASET}.list
  find ${DATA_DIR}/subdata8/ -type f -name "*.femtoDst.root" >> ${MAIN_DIR}/split/runlist_${DATASET}.list
  find ${DATA_DIR}/subdata10/ -type f -name "*.femtoDst.root" >> ${MAIN_DIR}/split/runlist_${DATASET}.list
  find ${DATA_DIR}/subdata13/ -type f -name "*.femtoDst.root" >> ${MAIN_DIR}/split/runlist_${DATASET}.list
  find ${DATA_DIR}/subdata21/ -type f -name "*.femtoDst.root" >> ${MAIN_DIR}/split/runlist_${DATASET}.list
